...
@section('content')
        ...
        <a href="{{ route('home') }}" type="button"
                class="
                    ...
                    focus:ring-4 focus:outline-none focus:ring-slate-900
                    text-white rounded-md font-medium w-full
                    inline-flex items-center justify-center
                    text-lg px-6 py-3 unmobile:text-sm unmobile:px-5 unmobile:py-2.5">
                Kembali
            </a>
@endsection
