...
@section('content')
    ...
    <form id="formCheck" class="mt-6 py-4 px-2 border border-rose-300 rounded-md bg-rose-50">
        <div class="mb-4">
            <label class="text-sm block mb-2" for="ketuaan">Berapa hari setelah tanam bawang merah Anda?</label>
            <input placeholder="1"
        ...
        <div class="mb-4">
            <label class="text-sm block mb-2" for="kekerasan">Bagaimana tekstur kekerasan bawang merah Anda?</label>
            <select id="kekerasan" name="kekerasan"
                ...
                <option value="0">Cukup Keras</option>
            </select>
        </div>

        <div class="mb-4">
            <label class="text-sm block mb-2" for="kebusukan">Apakah bawang merah Anda mengalami kebusukan?</label>
        ...
        <div class="mb-4">
            <label class="text-sm block mb-2" for="kerusakan">Apakah bawang merah Anda mengalami kerusakan?</label>
        ...
        <div class="mb-4">
            <label class="text-sm block mb-2" for="kadar_air">Berapa kadar air pada bawang merah Anda? (%)</label>
            <input
                class="block w-full p-2 text-gray-900 border border-rose-300 rounded-lg bg-gray-50 sm:text-xs focus:ring-rose-500 focus:border-rose-500"
        ...
        <div class="mb-4">
            <label class="text-sm block mb-2" for="diameter">Berapa berapa diameter bawang merah Anda? (cm)</label>
            <input
                class="block w-full p-2 text-gray-900 border border-rose-300 rounded-lg bg-gray-50 sm:text-xs focus:ring-rose-500 focus:border-rose-500"
